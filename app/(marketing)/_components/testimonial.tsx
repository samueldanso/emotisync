...
const TestimonialCard = ({ testimonial }: { testimonial: Testimonial }) => (
  <div className="hover:-translate-y-0.5 flex w-[280px] flex-shrink-0 flex-col rounded-[24px] bg-white/80 p-6 ring-1 ring-black/[0.01] backdrop-blur-md transition-all hover:bg-opacity-90 sm:w-[360px] dark:bg-zinc-600/30 dark:ring-white/[0.01]">
    <CardContent className="p-0">
      <p className="font-medium text-brand-muted leading-relaxed">
        {testimonial.content}
      </p>
      <div className="mt-6 flex items-center">
        ...
        <div>
          ...
          <p className="font-medium text-brand-muted">{testimonial.role}</p>
        </div>
      </div>
    </CardContent>
  </div>
        ...
        <ScrollAnimation>
          <div className="relative z-10 mx-auto flex max-w-[58rem] flex-col items-center px-4 text-center">
            ...
            <p className="mt-6 max-w-[85%] font-medium text-brand-muted text-lg leading-relaxed sm:text-xl">
              Thousands connect daily with their emotions with EmotiSync.
            </p>
          </div>
        </ScrollAnimation>
