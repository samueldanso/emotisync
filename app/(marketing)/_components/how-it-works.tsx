        ...
        <ScrollAnimation>
          <div className="relative z-10 mx-auto flex max-w-[58rem] flex-col items-center px-4 text-center">
            ...
            <h2 className="mt-6 font-heading font-semibold text-3xl text-brand-foreground sm:text-4xl md:text-5xl">
              Speak, reflect, <br /> get personalized recommendations
            </h2>
            <p className="mt-6 max-w-[85%] font-medium text-brand-muted text-lg leading-relaxed sm:text-xl">
              ...
              reflections and actionable recommendations tailored to your
              emotional needs.
            </p>
          </div>
        </ScrollAnimation>
            ...
            <ScrollAnimation key={step.title}>
              ...
              >
                <div className="w-full space-y-4 md:w-1/2 md:pr-6">
                  ...
                  <p className="font-medium text-brand-muted leading-relaxed md:text-lg">
                    {step.description}
                  </p>
                </div>
